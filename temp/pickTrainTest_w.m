function [dataset, Y_train, label_train, Y_test, label_test] = pickTrainTest_w(dataset, N_train_c)
    %data_fn = fullfile('data', strcat(dataset, '.mat'))
    %load(data_fn);
    %load('./data/randomfaces4extendedyaleb.mat');
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%        
...
%     myFileExtension = '*.jpg';
    ...
    [Y, Y_range] = recurse_dwt_sub(myRootDir, mySubDirPattern, myFileExtension);
    %Y = normc(Y);
    d = size(Y,1);
    %=== Test mode ========================
